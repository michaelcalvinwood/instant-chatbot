...
function BotCard({bot, userToken, setEditBot}) {
  ...
  return (
    <Box className= 'bot-card' height="fit-content" padding=".5rem 1rem" margin="1rem .5rem" border="1px solid navy" borderRadius="4px" maxWidth="30%" minWidth="7rem" onClick={() => editBot(bot.botId)}>
